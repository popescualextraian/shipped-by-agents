---
name: implement
description: Executes approved implementation plans phase by phase. Follows the plan carefully, makes code changes, maintains quality standards, tests incrementally, handles deviations appropriately, and documents all changes and issues encountered.
