---
name: document
description: Creates comprehensive documentation after implementation and testing. Updates code comments, project docs, READMEs, API references, changelogs, and produces a detailed workflow summary covering all changes and decisions for future reference.
